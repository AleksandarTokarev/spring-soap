...
/**
 * <p>Java class for WSMoneyCodeById complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WSMoneyCodeById"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="uses" type="{http://com.tch.cards.service/types}MoneyCodeUseById" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "WSMoneyCodeById", propOrder = {
    "activeDate",
    "alphaCode",
    "amount",
    "amountUsed",
...
public class WSMoneyCodeById {
    ...
    protected List<MoneyCodeUseById> uses;
    @XmlElement(required = true, nillable = true)
    @XmlSchemaType(name = "dateTime")
     ...
     * {@link MoneyCodeUseById }
     * 
     * 
     */
    public List<MoneyCodeUseById> getUses() {
        if (uses == null) {
            uses = new ArrayList<MoneyCodeUseById>();
        }
        return this.uses;
    }
