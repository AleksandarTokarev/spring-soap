 ...
 *         &lt;element name="lineItems" type="{http://com.tch.cards.service/types}WSTransactionLineItem" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class WSTransaction {
    ...
    @XmlElement(nillable = true)
    protected List<WSTransactionLineItem> lineItems;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link WSTransactionLineItem }
     * 
     * 
     */
    public List<WSTransactionLineItem> getLineItems() {
        if (lineItems == null) {
            lineItems = new ArrayList<WSTransactionLineItem>();
        }
